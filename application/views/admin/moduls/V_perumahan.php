...
<div class="row">
    <div class="col-md-12">
        <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Perumahan</a>
        </div>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah Perumahan</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Nama Perumahan</label>
                                    <input type="text" class="form-control" name="nama_perumahan" placeholder="Nama Perumahan" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Alamat Perumahan</label>
                                    <textarea class="form-control" name="alamat_perumahan" id="input_deskripsi" placeholder="Alamat Perumahan"></textarea>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label>Long</label>
                                    <input type="text" class="form-control" name="long" placeholder="Long" required>
                                </div>
                            </div>
                        </div>
                ...
                if (count($result) > 0) {
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value->alamat_perumahan ?></td>
                            <td><?= $value->lat ?></td>
                            <td><?= $value->long ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->id_perumahan ?>')">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->id_perumahan ?>')">
