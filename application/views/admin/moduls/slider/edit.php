...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form class="form-horizontal" role="form" id="formEditSlider" action="<?= base_url('C_slider/edit_produk') ?>" method="POST" enctype="multipart/form-data">
            <input type="reset" class="hidden">
            <input type="hidden" name="id_slider" value="<?= $data->id_slider ?>">

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h3 class="smaller lighter blue no-margin">Edit Slider</h3>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <label>Slider</label>
                        <input type="file" class="form-control" name="nama_slider" id="edit_input_foto5">
                    </div>               
                </div>
            </div>
