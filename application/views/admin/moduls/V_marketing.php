...
<div class="row">
    <div class="col-md-12">
        <div style="padding-bottom: 10px;">
            <a href="#tambahproduk" role="button" class="btn btn-primary" data-toggle="modal">Tambah Marketing</a>
        </div>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" id="formAddPengalaman" action="<?= base_url(uri_string() . '/add_produk') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-header">
                            ...
                            <h3 class="smaller lighter blue no-margin">Tambah Marketing</h3>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="nama_marketing" placeholder="Nama Marketing" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Alamat Marketing</label>
                                    <textarea class="form-control" name="alamat_marketing" id="input_deskripsi" placeholder="Alamat Marketing"></textarea>
                                </div>

                                <div class="col-md-12">
                                    <label>No. Handphone Marketing</label>
                                    <input type="number" class="form-control" name="nohp_marketing" placeholder="No. Handphone Marketing" required>
                                </div>

                                <div class="col-md-12">
                                    <label>Email Marketing</label>
                                    <input type="text" class="form-control" name="email_marketing" placeholder="Email Marketing" required>
                                </div>
                            </div>
                        </div>
                ...
                if (count($result) > 0) {
                    ...
                    foreach ($result as $key => $value) { ?>
                        <tr>
                            ...
                            <td><?= $value->alamat_marketing ?></td>
                            <td><?= $value->nohp_marketing ?></td>
                            <td><?= $value->email_marketing ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-xs" onclick="edit_produk('<?= $value->username ?>')">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-xs" onclick="delete_produk('<?= $value->username ?>')">
